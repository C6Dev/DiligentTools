if(PLATFORM_WIN32)
    ...
    function(copy_required_dlls TARGET_NAME)
        ...
        if(METAL_SUPPORTED)
            # list(APPEND ENGINE_DLLS Diligent-GraphicsEngineMetal-shared)  # Disabled: only static Metal lib is built
        endif()
        if(WEBGPU_SUPPORTED)
...
function(get_supported_backends _TARGETS)
    ...
    if(METAL_SUPPORTED)
        list(APPEND BACKENDS Diligent-GraphicsEngineMetal-static)
    endif()
    if(WEBGPU_SUPPORTED)
