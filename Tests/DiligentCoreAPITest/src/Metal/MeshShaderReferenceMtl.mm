...
{
    // Note: Metal mesh shader implementation requires MSL mesh shaders
    // which are not yet implemented in this test suite.
...
{
    // Note: Metal mesh shader indirect draw implementation requires MSL mesh shaders
    // which are not yet implemented in this test suite.
}

void AmplificationShaderDrawReferenceMtl(ISwapChain* pSwapChain)
{
    // Note: Metal amplification shader (equivalent to object shader) implementation
    // requires MSL shaders which are not yet implemented in this test suite.
}
