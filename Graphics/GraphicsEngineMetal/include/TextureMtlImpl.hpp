...
/// Texture object implementation in Metal backend.
...
public:
    ...
    virtual id<MTLResource> DILIGENT_CALL_TYPE GetMtlResource() const override final;

    /// Implementation of ITextureMtl::GetMtlHeap().
    virtual id<MTLHeap> DILIGENT_CALL_TYPE GetMtlHeap() const override final;
