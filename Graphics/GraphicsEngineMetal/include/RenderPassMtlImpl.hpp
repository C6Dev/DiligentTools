...
/// Implementation of a render pass in Metal backend.
class RenderPassMtlImpl final : public DeviceObjectBase<IRenderPass, RenderDeviceMtlImpl, RenderPassDesc>
{
public:
    using TBase = DeviceObjectBase<IRenderPass, RenderDeviceMtlImpl, RenderPassDesc>;
